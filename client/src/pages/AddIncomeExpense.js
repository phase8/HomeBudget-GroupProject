      ...
      <div className="pageContainer">
        <div className="statusContainer">
          ...
          <form onSubmit={this.submit}>
            ...
            <select name="category" value={this.state.category} onChange={this.handleChange}>
              <option disabled={this.state.operationtype == "przychód" ? true : false} value="wybierz">{this.state.operationtype == "przychód" ? "nie dotyczy" : "wybierz"}</option>
              {
                this.state.categories.map((obj) => {
                  ...
                  return <option disabled={this.state.operationtype == "przychód" ? true : false} name="category" value={obj.total}>{obj.total}</option>
                })
              }</select>
            ...
            <select name="operationtype" value={this.state.operationtype} onChange={this.handleChange}>
            ...
            <select name="ispernament" value={this.state.ispernament} onChange={this.handleChange}>
              <option value="wybierz">wybierz</option>
