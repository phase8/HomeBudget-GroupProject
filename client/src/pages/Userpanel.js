    ...
    return (
      <div className="pageContainer">
        <div className="controls">
          ...
          <div className="controlButton">Cele</div>
          <div className="controlButton">Kategorie</div>
          <div className="controlButton">Historia</div>
          <Link to="/logout">
            <div className="controlButton">Wyloguj (nazwa użytkownika)</div>
          </Link>
        </div>
